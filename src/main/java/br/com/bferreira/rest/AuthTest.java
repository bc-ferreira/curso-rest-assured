...
public class AuthTest {
    ...
    public void deveFazerAutenticacaoComToken() {
        ...
        .then()
            .log().all()
            .statusCode(200)//valida se a lista contem a chave nome, com o valor bferreira
            .body("nome", hasItem("bferreira"));
    }
    ...
    public void deveAcessarAplicacaoWeb() {
        ...
        .then()
            ...
            .body("html.body.table.tbody.tr[0].td[0]", is("bferreira"))
